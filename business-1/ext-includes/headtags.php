<head>
  ...
  <link rel="shortcut icon" href="<?php echo $siteData['siteURL']."/".$siteData['templateDir']; ?>/assets/images/logo-only-121x92.png" type="image/x-icon">
  <title><?php echo $siteData['officeName']; ?> | eOffice NG</title>
  <meta name="description" content="<?php echo $siteData['officeDesc']; ?>">
  <link rel="stylesheet" href="<?php echo $siteData['siteURL']."/".$siteData['templateDir']; ?>/assets/web/assets/mobirise-icons/mobirise-icons.css">
  ...
  <link rel="stylesheet" href="<?php echo $siteData['siteURL']."/".$siteData['templateDir']; ?>/assets/gallery/style.css">
  ...
  <link rel="stylesheet" href="<?php echo $siteData['siteURL']; ?>/assets/fontawesome/css/all.css" type="text/css">
